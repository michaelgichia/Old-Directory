...
export const baseEventAPI = 'https://staging.mymookh.com/stores/event/public';
export const ordersPayAPI = 'https://staging.mymookh.com/stores/orders';
export const orderStatusAPI = 'https://staging.mymookh.com/stores/orders/order_status';
